      ...
      <div className="bg-linear-to-r from-app-orange to-app-orange-dark text-white py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex-center gap-2 mb-3">
            ...
            <h1 className="text-3xl font-semibold">India Bazaar Specials</h1>
            <Zap className="size-6 fill-white" />
          </div>
          <p className="text-white/80 max-w-md mx-auto">
            Featured offers on Indian groceries, snacks, pantry staples, frozen
            foods, sweets, and fresh produce.
          </p>
        </div>
      </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-sm text-app-text-light">
              Check back soon for new India Bazaar OKC offers.
            </p>
          </div>
        ) : (
