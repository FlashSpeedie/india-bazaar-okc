# India Bazaar OKC - Full Stack Store Website

A full-stack store website for **India Bazaar OKC**, an Indian and South Asian grocery store in Oklahoma City. The project includes a customer storefront, product catalog, cart, checkout flow, admin panel, delivery partner dashboard, image uploads, and order tracking.

**Store:** India Bazaar OKC  
